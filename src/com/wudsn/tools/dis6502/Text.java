...
public final class Text extends NLS {
	...
	public static String IDS_ERR_IMG_FILE_NOT_FOUND;
	public static String IDS_ERR_IMG_OUT_OF_RANGE;
	public static String IDS_ERR_IMG_WRITE_PROTECT;
	public static String IDS_ERR_LABEL_OVEFLOW;
	public static String IDS_ERR_LOHI_FIRST;
	public static String IDS_ERR_MULTI_LOHI;
	public static String IDS_ERR_NO_ATARI_FILE;
	public static String IDS_ERR_NO_BOOT;
