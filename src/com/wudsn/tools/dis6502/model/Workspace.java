 ...
 * {@link SegmentList} needs (the system/user equate lists and the
 * instruction sets). The rest - the computer system, profile, disassembly
 * result, and XML persistence via wudsn-base's {@code XMLUtility} - is
 * ported later.
 *
 * @author Peter Dell
 */
