...
public final class CommandLineArgumentsTest {
	...
	public static void testCommandLineArguments() {
		CommandLineArguments none = CommandLineArguments.parse(new String[0]);
		Assert.boolEquals(none.computerSystemTypeID == null, true);
		Assert.boolEquals(none.file == null, true);

		CommandLineArguments systemOnly = CommandLineArguments.parse(new String[] { "/C64" });
		...
		CommandLineArguments both = CommandLineArguments.parse(new String[] { "-atari5200", "game.rom" });
		...
		CommandLineArguments fileOnly = CommandLineArguments.parse(new String[] { "game.xex" });
		...
		CommandLineArguments unixPath = CommandLineArguments.parse(new String[] { "/home/me/game.xex" });
		...
		CommandLineArguments blanks = CommandLineArguments.parse(new String[] { "/ORIC", "my", "game.tap" });
