...
/**
 * Verifies that {@link MemoryType}'s ordinals (used as raw bytes in a
 * memory inspector's type buffer) still match the binary encoding used
 * since application version 2.2 - {@link MemoryType} already performs
 * that exact check at class-load time ({@link
 * MemoryType#ORDINALS_MATCH_VERSION_22}, throwing an {@link
